...
function merge(light, dark) {
    const isSignal = (v) => v instanceof Signal;
    const isPlainObject = (v) => v != null && typeof v === 'object' && !isSignal(v);
    ...
    if (!isPlainObject(light) || !isPlainObject(dark)) {
        return computed(() => {
            ...
            const d = isSignal(dark) ? dark.value : dark;
...
export const theme = merge(lightTheme, darkTheme);
