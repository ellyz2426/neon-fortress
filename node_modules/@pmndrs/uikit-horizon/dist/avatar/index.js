...
export const AvatarOutPropertiesSchema = /* @__PURE__ */ defineSchema(() => object({
    ...baseOutPropertyShape,
    src: string().optional(),
    attributionActive: boolean().optional(),
    attributionSrc: string().optional(),
    size: enumSchema(Object.keys(avatarSizes)).optional(),
    selected: boolean().optional(),
}).strict());
export const AvatarPropertiesSchema = /* @__PURE__ */ defineSchema(() => createInPropertiesSchema(AvatarOutPropertiesSchema));
export class Avatar extends Container {
    ...
    constructor(inputProperties, initialClasses, config) {
        ...
        //avatar image
        super.add((this.image = new Image({ src: this.properties.value.src }, undefined, {
            defaultOverrides: {
                width: '100%',
                height: '100%',
                aspectRatio: 1,
