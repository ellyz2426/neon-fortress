...
export const SliderOutPropertiesSchema = /* @__PURE__ */ defineSchema(() => object({
    ...
    icon: custom((value) => typeof value === 'function').optional(),
}).strict());
export const SliderPropertiesSchema = /* @__PURE__ */ defineSchema(() => createInPropertiesSchema(SliderOutPropertiesSchema));
const sliderHeights = {
    sm: 12,
    md: 28,
    lg: 44,
