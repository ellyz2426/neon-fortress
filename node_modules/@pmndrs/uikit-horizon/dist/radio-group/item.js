...
export const RadioGroupItemOutPropertiesSchema = /* @__PURE__ */ defineSchema(() => object({
    ...baseOutPropertyShape,
    value: string().optional(),
}).strict());
export const RadioGroupItemPropertiesSchema = /* @__PURE__ */ defineSchema(() => createInPropertiesSchema(RadioGroupItemOutPropertiesSchema));
export class RadioGroupItem extends Container {
    button;
    constructor(inputProperties, initialClasses, config) {
        ...
        const isSelected = computed(() => this.parentContainer.value instanceof RadioGroup
        ...
        this.button = new Container(undefined, undefined, {
            defaultOverrides: {
                ...
                borderWidth: 4,
                borderRadius: 1000,
                borderColor: computed(() => isSelected.value ? theme.component.radioButtons.background.selected.value : undefined),
                ...
                important: {
                    backgroundColor: computed(() => isSelected.value ? theme.component.radioButtons.icon.selected.value : undefined),
                },
            },
        });
