...
import { abortableEffect, Container, Input as InputImpl, } from '@pmndrs/uikit';
...
const inputSizes = _inputSizes;
export const InputOutPropertiesSchema = /* @__PURE__ */ defineSchema(() => object({
    ...baseOutPropertyShape,
    size: enumSchema(Object.keys(inputSizes)).optional(),
    variant: enumSchema(['search', 'text']).optional(),
    textAlign: enumSchema(['center', 'left']).optional(),
    leftIcon: custom((value) => typeof value === 'function').optional(),
    rightIcon: custom((value) => typeof value === 'function').optional(),
    ...
    constructor(inputProperties, initialClasses, config) {
        ...
        super(inputProperties, initialClasses, {
            ...
            defaultOverrides: {
                ...
                fontWeight: 500,
                color: computed(() => (this.properties.value.variant ?? 'text') === 'text'
        ...
        const iconSize = computed(() => (this.properties.value.variant ?? 'text') === 'search' && (this.properties.value.size ?? 'lg') === 'lg' ? 24 : 16);
        ...
        const iconColor = computed(() => (this.properties.value.variant ?? 'text') === 'search'
