...
class XRInputManager {
    constructor(options) {
        ...
        this.touchSurfaceVisualOffsets = {
            left: new Vector3(),
            right: new Vector3(),
        };
    ...
    updatePointers(delta, time) {
        ['left', 'right'].forEach((handedness) => {
            ...
            const touchSurfaceVisualOffset = this.multiPointers[handedness].getTouchSurfaceVisualOffset(this.touchSurfaceVisualOffsets[handedness]);
            const handAdapter = this.visualAdapters.hand[handedness];
