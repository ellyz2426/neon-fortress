...
class XRHandVisualAdapter extends XRInputVisualAdapter {
    constructor(playerSpace, handedness, visualsEnabled, visualClass, scene, camera, assetLoader) {
        ...
        this.visualOffsetStart = new Vector3();
        this.visualOffsetEnd = new Vector3();
     ...
     */
    applyVisualOffsetWorld(offsetWorld) {
        if (!this.visual) {
            return;
        }
        ...
        this.visual.model.position.add(this.visualOffsetEnd.sub(this.visualOffsetStart));
    }
}
