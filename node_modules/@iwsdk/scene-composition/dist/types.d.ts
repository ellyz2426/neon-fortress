 ...
 */
export declare const CURRENT_SCENE_VERSION: "iwsdk.scene.v1";
export declare const CURRENT_SCENE_REVIEW_VERSION: "iwsdk.scene-review.v1";
export declare const MAX_SCENE_CORRECTION_ROUNDS = 10;
export declare const SCENE_PROCEDURAL_TEXTURE_RESOLUTIONS: readonly [64, 128, 256, 512, 1024, 2048];
export declare const MAX_SCENE_PROCEDURAL_TEXTURE_DIMENSION = 2048;
export declare const MAX_SCENE_PROCEDURAL_TEXTURE_TEXELS = 16777216;
export declare const MAX_SCENE_PROCEDURAL_TEXTURE_SAMPLES = 67108864;
export declare const SCENE_IMPORT_ID_PATTERN = "^[A-Za-z][A-Za-z0-9_-]*$";
...
export type SceneComponentFieldType = 'Int8' | 'Int16' | 'Int32' | 'Entity' | 'Float32' | 'Float64' | 'Boolean' | 'String' | 'FilePath' | 'Object' | 'Vec2' | 'Vec3' | 'Vec4' | 'Color' | 'Enum';
...
export type SceneComponentCatalog = Readonly<Record<string, SceneComponentSchema>>;
...
export interface SceneProceduralAlbedoTexture extends SceneProceduralTextureBase {
    ramp: SceneProceduralColorStop[];
}
export interface SceneProceduralScalarTexture extends SceneProceduralTextureBase {
    range: Vec2;
}
export interface SceneProceduralNormalTexture extends SceneProceduralTextureBase {
    scale?: Vec2;
}
...
export type SceneMaterial = SceneStandardMaterial | ScenePhysicalMaterial | SceneBasicMaterial;
...
export type SceneCylinderGeometry = SceneUniformCylinderGeometry | SceneTaperedCylinderGeometry;
...
export type SceneGeometry = SceneBoxGeometry | SceneSphereGeometry | SceneCylinderGeometry | SceneConeGeometry | ScenePlaneGeometry | SceneCapsuleGeometry | SceneExtrudeGeometry | SceneTubeGeometry | SceneLatheGeometry | SceneTorusGeometry | SceneRoundedBoxGeometry;
...
export type ScenePatternDistribution = SceneLinearDistribution | SceneGridDistribution | SceneRadialDistribution | SceneAlongPathDistribution | SceneScatterDistribution | SceneExplicitDistribution;
...
export type SceneNodeContent = SceneGroupContent | SceneAssetContent | SceneInstanceContent | ScenePatternContent;
...
export type ScenePlayerTarget = 'player' | 'camera' | 'head' | 'left-target-ray' | 'right-target-ray' | 'left-grip' | 'right-grip';
...
export interface SceneSpatialRelationAcceptance extends SceneAcceptanceBase {
    ...
    nodeRefs: string[];
    target: string;
    relation: 'above' | 'below' | 'left-of' | 'right-of' | 'in-front-of' | 'behind' | 'touching';
    tolerance?: number;
}
...
export type SceneFeatureAcceptance = ScenePresenceAcceptance | SceneCountAcceptance | SceneProjectedRegionAcceptance | SceneSpatialRelationAcceptance | SceneVisualJudgmentAcceptance;
...
export interface SceneReviewStop {
    reason: 'success' | 'continue-refining' | 'round-limit' | 'repeated-defect' | 'oscillation' | 'plateau' | 'missing-input' | 'representation-gap';
...
export type ScenePatch = {
    ...
    op: 'updateAuthoringView';
    viewId: string;
    view: SceneAuthoringView;
} | {
    op: 'removeAuthoringView';
    viewId: string;
};
