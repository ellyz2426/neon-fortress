...
import { Hovered, PokeInteractable, Pressed, RayInteractable } from '../input/state-tags.js';
...
import { AmbientLightComponent, DirectionalLightComponent, HemisphereLightComponent, PointLightComponent, RectAreaLightComponent, SpotLightComponent } from '../lighting/light-components.js';
...
const IWSDK_BUILTIN_COMPONENTS = defineComponents([
    AudioSource,
...
export { IWSDK_BUILTIN_COMPONENTS };
