...
export declare class LocomotionEngine {
    ...
    groundDecel: number;
    positionUpdateTimeout: number;
    gravity: number;
    rayGravity: number;
    updating: boolean;
    isGrounded: boolean;
    isGroundedOnStatic: boolean;
    ...
    slide(movementVector: Vector3): void;
    teleport(position: Vector3): void;
    raycast(origin: Vector3, direction: Vector3, far: number): Intersection<import("three").Object3D<import("three").Object3DEventMap>> | undefined;
    private raycastRelevantEnvironments;
    parabolicRaycast(origin: Vector3, direction: Vector3): Intersection<import("three").Object3D<import("three").Object3DEventMap>> | undefined;
    update(delta: number): void;
    updatePlayerPosition(delta: number): void;
    private handleMovementPhysics;
    private applyGravity;
    private handleGroundContact;
